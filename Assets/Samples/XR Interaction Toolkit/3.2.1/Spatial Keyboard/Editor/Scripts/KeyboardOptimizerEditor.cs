...
namespace UnityEditor.XR.Interaction.Toolkit.Samples.SpatialKeyboard
{
    ...
    /// </summary>
    [CustomEditor(typeof(KeyboardOptimizer), true)]
    ...
    public class KeyboardOptimizerEditor : BaseInteractionEditor
    {
        ...
        ///     <see cref="KeyboardOptimizer.batchGroupParentTransform" />.
        /// </summary>
        protected SerializedProperty m_BatchGroupParentTransform;

        /// <summary>
        ///     <see cref="SerializedProperty" /> of the <see cref="SerializeField" /> backing
        ///     <see cref="KeyboardOptimizer.buttonParentTransform" />.
        /// </summary>
        protected SerializedProperty m_ButtonParentTransform;

        /// <summary>
        ///     <see cref="SerializedProperty" /> of the <see cref="SerializeField" /> backing
        ///     <see cref="KeyboardOptimizer.highlightParentTransform" />.
        /// </summary>
        protected SerializedProperty m_HighlightParentTransform;

        /// <summary>
        ///     <see cref="SerializedProperty" /> of the <see cref="SerializeField" /> backing
        ///     <see cref="KeyboardOptimizer.iconParentTransform" />.
        /// </summary>
        protected SerializedProperty m_IconParentTransform;

        /// <summary>
        ///     <see cref="SerializedProperty" /> of the <see cref="SerializeField" /> backing
        ///     <see cref="KeyboardOptimizer.imageParentTransform" />.
        /// </summary>
        protected SerializedProperty m_ImageParentTransform;

        private KeyboardOptimizer m_KeyboardTarget;

        /// <summary>
        ///     <see cref="SerializedProperty" /> of the <see cref="SerializeField" /> backing
        ///     <see cref="KeyboardOptimizer.optimizeOnStart" />.
        /// </summary>
        protected SerializedProperty m_OptimizeOnStart;

        /// <summary>
        ///     <see cref="SerializedProperty" /> of the <see cref="SerializeField" /> backing
        ///     <see cref="KeyboardOptimizer.textParentTransform" />.
        /// </summary>
        ...
        protected virtual void DrawProperties()
        {
            ...
            m_BatchGroupParentTransform.isExpanded =
                EditorGUILayout.BeginFoldoutHeaderGroup(m_BatchGroupParentTransform.isExpanded,
                    Contents.batchTransformReferencesHeader);
        ...
        protected static class Contents
        {
            ...
            public static readonly GUIContent optimizeOnStart = EditorGUIUtility.TrTextContent("Optimize On Start",
                "If enabled, the optimization will be called on Start.");

            /// <summary><see cref="GUIContent" /> for the <see cref="KeyboardOptimizer.batchGroupParentTransform" /> property.</summary>
            public static readonly GUIContent batchGroupParentTransform =
                EditorGUIUtility.TrTextContent("Batch Group Parent Transform",
            ...
            public static readonly GUIContent buttonParentTransform =
                EditorGUIUtility.TrTextContent("Button Parent Transform", "The parent transform for buttons.");

            /// <summary><see cref="GUIContent" /> for the <see cref="KeyboardOptimizer.imageParentTransform" /> property.</summary>
            public static readonly GUIContent imageParentTransform =
                EditorGUIUtility.TrTextContent("Image Parent Transform", "The parent transform for images.");

            /// <summary><see cref="GUIContent" /> for the <see cref="KeyboardOptimizer.textParentTransform" /> property.</summary>
            public static readonly GUIContent textParentTransform =
                EditorGUIUtility.TrTextContent("Text Parent Transform", "The parent transform for text elements.");

            /// <summary><see cref="GUIContent" /> for the <see cref="KeyboardOptimizer.iconParentTransform" /> property.</summary>
            public static readonly GUIContent iconParentTransform =
                EditorGUIUtility.TrTextContent("Icon Parent Transform", "The parent transform for icons.");

            /// <summary><see cref="GUIContent" /> for the <see cref="KeyboardOptimizer.highlightParentTransform" /> property.</summary>
            public static readonly GUIContent highlightParentTransform =
                EditorGUIUtility.TrTextContent("Highlight Parent Transform", "The parent transform for highlights.");

            /// <summary><see cref="GUIContent" /> for Batch Transform References header label.</summary>
            public static readonly GUIContent batchTransformReferencesHeader =
                EditorGUIUtility.TrTextContent("Batch Transform References");

            /// <summary><see cref="GUIContent" /> for Optimize button.</summary>
            public static readonly GUIContent optimizeButton =
                EditorGUIUtility.TrTextContent("Optimize", "This is the same as call Optimize() in the script.");

            /// <summary><see cref="GUIContent" /> for Unoptimize button.</summary>
            public static readonly GUIContent unoptimizeButton =
                EditorGUIUtility.TrTextContent("Unoptimize", "This is the same as call Unoptimize() in the script.");
            ...
            public static readonly GUIContent optimizationOnlySingleObject =
                EditorGUIUtility.TrTextContent("Optimization is only available when a single GameObject is selected.");

            /// <summary><see cref="GUIContent" /> for the message label when not in a scene.</summary>
            public static readonly GUIContent optimizationOnlyInScene =
                EditorGUIUtility.TrTextContent("Optimization is only available with scene objects during runtime.");

            /// <summary><see cref="GUIContent" /> for the message label when not in Play mode.</summary>
            public static readonly GUIContent optimizationOnlyDuringRuntime =
                EditorGUIUtility.TrTextContent("Optimization is only available during runtime.");
        }
    }
}