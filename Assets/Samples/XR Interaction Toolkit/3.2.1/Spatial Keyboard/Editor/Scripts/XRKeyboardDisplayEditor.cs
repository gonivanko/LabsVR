...
namespace UnityEditor.XR.Interaction.Toolkit.Samples.SpatialKeyboard
{
    ...
    /// </summary>
    [CustomEditor(typeof(XRKeyboardDisplay), true)]
    ...
    public class XRKeyboardDisplayEditor : BaseInteractionEditor
    {
        ...
        {
            m_OnTextSubmitted.isExpanded =
                EditorGUILayout.Foldout(m_OnTextSubmitted.isExpanded, Contents.keyboardEvents, true);
        ...
        {
            public static readonly GUIContent inputField =
                EditorGUIUtility.TrTextContent("Input Field", "Input field linked to this display");

            public static readonly GUIContent keyboard = EditorGUIUtility.TrTextContent("Keyboard",
            ...
            public static readonly GUIContent useSceneKeyboard = EditorGUIUtility.TrTextContent("Use Scene Keyboard",
            ...
            public static readonly GUIContent updateOnKeyPress = EditorGUIUtility.TrTextContent("Update on Key Press",
                "If true, this display will update with each key press. If false, this display will update on OnTextSubmit.");

            public static readonly GUIContent alwaysObserveKeyboard = EditorGUIUtility.TrTextContent(
                "Always Observe Keyboard",
            ...
            public static readonly GUIContent monitorInputFieldCharacterLimit = EditorGUIUtility.TrTextContent(
                "Monitor Input Field Character Limit",
            ...
            public static readonly GUIContent clearTextOnSubmit = EditorGUIUtility.TrTextContent("Clear Text on Submit",
                "If true, this display will clear the input field text on text submit from the keyboard.");

            public static readonly GUIContent clearTextOnOpen = EditorGUIUtility.TrTextContent("Clear Text on Open",
                "If true, this display will clear the input field text when the keyboard opens.");

            public static readonly GUIContent keyboardEvents = EditorGUIUtility.TrTextContent("Keyboard Display Events",
                "Events associated with the keyboard display");

            public static readonly GUIContent onKeyboardOpened = EditorGUIUtility.TrTextContent("On Keyboard Opened",
                "The event that is called when this display opens a keyboard.");

            public static readonly GUIContent onKeyboardClosed = EditorGUIUtility.TrTextContent("On Keyboard Closed",
                "The event that is called when the keyboard this display is observing is closed.");

            public static readonly GUIContent onKeyboardFocusChanged =
                EditorGUIUtility.TrTextContent("On Keyboard Focus Changed",
                    "The event that is called when the keyboard changes focus and this display is not focused.");

            public static readonly GUIContent onTextSubmitted = EditorGUIUtility.TrTextContent("On Text Submitted",
