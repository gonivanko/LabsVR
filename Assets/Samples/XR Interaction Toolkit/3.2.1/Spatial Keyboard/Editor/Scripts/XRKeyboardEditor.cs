...
namespace UnityEditor.XR.Interaction.Toolkit.Samples.SpatialKeyboard
{
    ...
    /// </summary>
    [CustomEditor(typeof(XRKeyboard), true)]
    ...
    public class XRKeyboardEditor : BaseInteractionEditor
    {
        ...
        private void DrawKeyboardEvents()
        {
            m_OnOpen.isExpanded = EditorGUILayout.Foldout(m_OnOpen.isExpanded, Contents.keyboardEvents, true);
        ...
        {
            public static readonly GUIContent submitOnEnter = EditorGUIUtility.TrTextContent("Submit On Enter",
                "If true, On Text Submit will be invoked when the keyboard receives a return or enter command. Otherwise it will treat return or enter as a newline.");

            public static readonly GUIContent closeOnSubmit = EditorGUIUtility.TrTextContent("Close On Submit",
                "If true, keyboard will close on enter or return command.");

            public static readonly GUIContent doubleClickInterval =
                EditorGUIUtility.TrTextContent("Double Click Interval",
                    "Interval in which a key pressed twice would be considered a double click.");

            public static readonly GUIContent subsetLayout = EditorGUIUtility.TrTextContent("Subset Layout",
                "List of layouts this keyboard is able to switch between given the corresponding layout command.");

            public static readonly GUIContent keyboardEvents =
                EditorGUIUtility.TrTextContent("Keyboard Events", "Events associated with the keyboard.");

            public static readonly GUIContent onTextSubmit =
                EditorGUIUtility.TrTextContent("On Text Submitted", "Event invoked when keyboard submits text.");

            public static readonly GUIContent onTextUpdate =
                EditorGUIUtility.TrTextContent("On Text Updated", "Event invoked when keyboard text is updated.");

            public static readonly GUIContent onKeyPressed =
                EditorGUIUtility.TrTextContent("On Key Pressed", "Event invoked after a key is pressed.");

            public static readonly GUIContent onShift =
                EditorGUIUtility.TrTextContent("On Shifted", "Event invoked after keyboard shift is changed.");

            public static readonly GUIContent onLayoutChange = EditorGUIUtility.TrTextContent("On Layout Changed",
                "Event invoked when the keyboard is opened. Called with the keyboard and the new layout string key.");

            public static readonly GUIContent onOpen =
                EditorGUIUtility.TrTextContent("On Opened", "Event invoked when the keyboard is opened.");

            public static readonly GUIContent onClose =
                EditorGUIUtility.TrTextContent("On Closed", "Event invoked after the keyboard is closed.");

            public static readonly GUIContent onFocusChanged = EditorGUIUtility.TrTextContent("On Focus Changed",
                "Event invoked when the keyboard changes or gains input field focus.");

            public static readonly GUIContent onCharacterLimitReached =
                EditorGUIUtility.TrTextContent("On Character Limit Reached",
