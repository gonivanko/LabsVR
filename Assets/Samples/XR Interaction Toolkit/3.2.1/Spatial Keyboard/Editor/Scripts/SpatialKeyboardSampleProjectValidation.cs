...
namespace UnityEditor.XR.Interaction.Toolkit.Samples.SpatialKeyboard.Editor
{
    ...
    /// </summary>
    internal static class SpatialKeyboardSampleProjectValidation
    {
        private const string k_SampleDisplayName = "Spatial Keyboard";
        ...
        private const string k_UIPackageName = "com.unity.ugui";
#else
        ...
        private static AddRequest s_UIPackageAddRequest;
        ...
        private static readonly List<BuildValidationRule> s_BuildValidationRules = new()
        {
            ...
            new BuildValidationRule
            {
                ...
                Message =
                    $"[{k_SampleDisplayName}] UGUI ({k_UIPackageName}) package must be installed for this sample.",
                Category = k_Category,
                ...
                FixIt = () =>
                {
                    ...
                    if (s_UIPackageAddRequest.Error != null)
                        Debug.LogError(
                            $"Package installation error: {s_UIPackageAddRequest.Error}: {s_UIPackageAddRequest.Error.message}");
                },
                FixItAutomatic = true,
                Error = true
            },
            ...
            new BuildValidationRule
            {
                ...
                HelpText =
                    "Can be installed using Window > TextMeshPro > Import TMP Essential Resources or by clicking this Edit button and then Import TMP Essentials in the window that appears.",
                Category = k_Category,
                CheckPredicate = () =>
                    PackageVersionUtility.IsPackageInstalled(k_UIPackageName) && TextMeshProEssentialsInstalled(),
        ...
        private static bool TextMeshProEssentialsInstalled()
        {
