...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    ///     Will run automatically OnEnable in the editor to set the shaders on project bootup. Can be refreshed manually with
    ///     editor button.
    ///     This exists because while objects render correctly using shadergraph shaders, others do not and using the standard
    ///     shader resolves various rendering issues.
    /// </summary>
    ...
    public class MaterialPipelineHandler : ScriptableObject
    {
        ...
        public void SetPipelineShaders()
        {
            ...
            foreach (var info in m_ShaderContainers)
            {
                ...
                var birpShader = info.useBuiltinShaderName
                    ? Shader.Find(info.builtInPipelineShaderName)
                    : info.builtInPipelineShader;
                var srpShader = info.useSRPShaderName
    ...
    public class ShaderContainerDrawer : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            var fieldsHeight = baseFieldCount * singleLineHeight +
    ...
    /// </summary>
    [CustomEditor(typeof(MaterialPipelineHandler))]
